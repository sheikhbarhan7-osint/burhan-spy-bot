...
// Firebase Admin setup (same as your working code)
...
// Global variable to track current operation (for cancellation)
...
app.listen(PORT, async () => {
    ...
    if (WEBHOOK_URL) {
        ...
        console.warn('RAILWAY_PUBLIC_DOMAIN not set. Manual webhook needed.');
    }
});
...
// /locate <ID> - get GPS and device info
